...
public class DatePickerDialog extends AppCompatDialogFragment implements
        OnClickListener, DatePickerController, TimePickerDialog.OnTimeSetListener {
    ...
    private TextView tv_label_remind;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        iv_remind = view.findViewById(R.id.iv_remind);
        tv_label_time = view.findViewById(R.id.tv_label_time);
        tv_label_remind = view.findViewById(R.id.tv_label_remind);
