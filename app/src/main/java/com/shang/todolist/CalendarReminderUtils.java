...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "CoderShang";
    private static String CALENDARS_ACCOUNT_NAME = "shangzhongjia@sina.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.shang";
    private static String CALENDARS_DISPLAY_NAME = "SQLite待办";
