...
public class MyFloatingActionButton extends FloatingActionButton {
    ...
    private int margin = UiUtils.dip2px(16);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE://手指滑动
                ...
                if (mViewGroup != null) {
                    ...
                    if (mRawX >= 0 && mRawX <= mRootMeasuredWidth && mRawY >= mRootTopY && mRawY <= (mRootMeasuredHeight + mRootTopY)) {
                        ...
                        //Y轴可以拖动的最大距离
                        float maxY = mRootMeasuredHeight - getHeight() - margin;
                        //X轴边界限制
            ...
            case MotionEvent.ACTION_UP://手指离开
                ...
                if (mLastRawX <= center) {
                    //向左贴边
                    MyFloatingActionButton.this.animate()
                    ...
                    MyFloatingActionButton.this.animate()
                            .setInterpolator(new BounceInterpolator())
                            .setDuration(500)
                            .x(mRootMeasuredWidth - margin - getWidth())
                            .start();
                }
                break;
        }
